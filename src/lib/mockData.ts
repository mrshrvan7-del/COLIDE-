...
export const employees: Employee[] = [
  ...
  { id: 'emp-006', name: 'Pooja Deshmukh', avatar: '', role: 'salesperson', level: 'senior', branchId: 'br-002', branchName: 'Colide Express', email: 'pooja@colide.in', phone: '+91 98765 43215', joinDate: '2024-07-15', salary: 27000, totalSales: 1980000, monthSales: 245000, weekSales: 63000, todaySales: 10500, conversionRate: 42, upsellRate: 18, attendanceRate: 90, customerRating: 4.4, targetAchieved: 102, streak: 10, points: 2650, rank: 6, badges: [], isOnDuty: true },
